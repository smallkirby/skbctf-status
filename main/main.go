...
func create_conf(logger zap.SugaredLogger) checker.CheckerConfig {
	...
	pnum := flag.Uint("pnum", 0, "Max number of paralleled tests.")
	...
	interval := flag.Uint("interval", 30, "Testing interval in minutes.")
